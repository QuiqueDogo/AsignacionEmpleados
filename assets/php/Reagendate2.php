...
$consulta3 = 'select emp_Nroemp, emp_nombrecompleto from adcom.empleados where emp_fchbaja is null and emp_jefe = "' . $datos_reporte['nsuper'] . '" and emp_proyecto in (71,176) and emp_puesto = "1";';
